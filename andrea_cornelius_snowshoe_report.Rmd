...
j_traps_table <- knitr::kable(head(juvenile_traps_stats),
  caption = "<b> Table 1. Descriptive statistics (mean, median, standard deviation, minimum and maximum count) for juvenile hares trapped at Bonanza Creek LTER from 1999-2012. Data: Kielland et al. 2017. <b>") %>%
...
The snowshoe hare population was largest in 1999, at a trapping count of 126.  declined with peaks in 2005, 2008, and 2011. Minimum in 2010 with a trapping count of 2, varying between. Not much data taken in 2002 or 2009 (not many visits to traps), hence no counts there.
