...
```{r}
ggplot(data = hare_subset_2, aes(x = sex, y = count, fill = sex)) +
  geom_bar(stat = "identity") +
  facet_wrap(~ grid) +
  scale_fill_manual(values=c("pink", "blue", "grey"),
                    name = "Sex") +
  labs(x = "Sex",
       y = "Juvenile Snowshoe Hare Count",
       title = "Number of Juvenile Snowshoe Hares by Site (CORNELIUS)") +
  theme_bw() +
